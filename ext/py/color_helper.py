...
def choose_color(_args):
    ...
    parser.add_argument("--skip-columns", type=str, action="append", default=["random_key", "layer", "#random_key", "topK", "topP"], help="Columns that are neither coordiante nor factor in the input file")
