...
protected:
    ...
    virtual const MatrixXd& get_model_matrix() const = 0;
    virtual MatrixXd copy_model_matrix() const = 0;
...
protected:
    ...
    const MatrixXd& get_model_matrix() const override {
        return lda->get_model();
    }
    MatrixXd copy_model_matrix() const override {
        return lda->get_model();
    }
